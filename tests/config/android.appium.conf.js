...
const config = {
    ...
    //
    specs: '/tests/features/featureFiles/*.feature',
    ...
    capabilities: [{
        ...
        // udid : //iOS attr,
        systemPort: //TODO,
        app: "./apps/android/Android-NativeDemoApp.apk", //TODO
        appWaitPackage: '//TODO',
    ...
    reporters: [
        'spec',
        ['json', {
          outputDir: './test/reports/json-results/android/'
        }]
    ],
